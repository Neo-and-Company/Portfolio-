...
const projectData: Project[] = [
  ...
  {
    id: 'proj6',
    title: 'Golf Performance Prediction Model & Analytics Platform',
    description: 'Advanced machine learning system that generates composite "Model Scores" (0-1 scale) to predict golf tournament performance using Course Fit (40%), Historical Performance (30%), General Form (20%), and Scorecard Prediction (10%) components. Provides data-driven insights for fantasy golf strategy, betting analysis, and tournament forecasting.',
    summary: 'Comprehensive golf analytics platform leveraging machine learning to predict player performance at specific tournaments, optimizing fantasy lineups, identifying betting value, and providing tournament insights through advanced statistical modeling.',
    keyFeatures: [
      'Composite Model Score generation (0-1 scale)',
      'Course Fit analysis with 40% weighting',
      'Historical Performance tracking (30% weight)',
      'General Form assessment (20% weight)',
      'Scorecard Prediction modeling (10% weight)',
      'Fantasy Golf DFS optimization',
      'Betting value identification',
      'Tournament contender forecasting'
    ],
    impact: 'Achieved 73% field coverage for fantasy lineups, identified undervalued players with superior model ratings vs. public perception, and provided quantifiable course setup impact analysis for data-driven golf strategy and media insights.',
    technologies: ['Python', 'Machine Learning', 'Statistical Modeling', 'Data Analytics', 'Pandas', 'NumPy', 'Scikit-learn', 'Golf Statistics API'],
