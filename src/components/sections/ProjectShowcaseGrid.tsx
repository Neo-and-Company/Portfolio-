...
const projectData: Project[] = [
  ...
  },
  {
    ...
    description: 'Developed a comprehensive e-commerce analytics platform delivering real-time metrics and actionable AI-driven predictive insights. Engineered and deployed advanced machine learning models including customer lifetime value (CLV) prediction using Gradient Boosting, LSTM-based sales forecasting system, and collaborative filtering recommendation engine. The platform processes 50,000+ data points daily, delivering sub-second predictions for dynamic pricing and inventory optimization, achieving 94% accuracy in demand forecasting and 87% precision in churn prediction.',
    summary: 'Enterprise-grade analytics solution combining real-time business intelligence with advanced machine learning capabilities, featuring end-to-end ML pipeline deployment and scalable prediction systems for e-commerce optimization.',
    keyFeatures: [
      'Real-time ML model deployment with sub-second prediction latency',
      'Advanced customer lifetime value (CLV) prediction using Gradient Boosting',
      'LSTM-based sales forecasting with 94% accuracy for demand planning',
      'Collaborative filtering recommendation engine with A/B testing framework',
      'Automated feature engineering pipeline processing 50K+ daily transactions',
      'Docker-containerized ML model deployment with Kubernetes orchestration'
    ],
    impact: 'Improved marketing ROI by 34% through CLV optimization, increased conversion rates by 28% via personalized recommendations, reduced inventory costs by 22% through accurate demand forecasting, and achieved 99.7% system uptime with scalable ML infrastructure.',
    technologies: ['React', 'Node.js', 'MongoDB', 'Python', 'Scikit-learn', 'TensorFlow', 'LSTM', 'Docker', 'Kubernetes', 'D3.js', 'Real-time ML'],
